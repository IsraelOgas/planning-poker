            ...
            <Slide in={true} direction="up" timeout={1500}>
              <div className="HomePageContainer">
                ...
                <Typography variant="subtitle1">
                  ...
                  to Vote). Once the card values are revealed, the card color
                  helps to understand if the team's voting is sync or not.
                  Session Moderator has full control on revealing story points
